...
6. To the fullest extent permitted by applicable law, **Vizrt NDI AB and its
   licensors are not liable for any damages** of any kind, whether direct,
   indirect, incidental or consequential, arising from use of this application
   or its bundled components.
...
ECANDI's default NDI sender. This is a native module written for this project
that reads Electron's offscreen shared textures and sends NDI off the main
thread. It is original work in this repository and is covered by the
repository's GPL-3.0 license. It links the same NDI runtime library described above.
